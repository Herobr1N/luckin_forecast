...
# @created: 2023/10/9
# @author: jieqin.lin
# @file: projects/basic_predict_promote/bpp13_pred_tree_40.py
...
############################################
(货物)总预测过去3个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_goods_last_3_acc_all")
bip3("model/basic_predict_promote_40", "lgbm_goods_last_3_acc_all")
bip3("model/basic_predict_promote_40, "catboost_goods_last_3_acc_all")

(货物)总预测过去2个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_goods_last_2_acc_all")
bip3("model/basic_predict_promote_40", "lgbm_goods_last_2_acc_all")
bip3("model/basic_predict_promote_40", "catboost_goods_last_2_acc_all")

(货物)总预测过去1个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_goods_last_1_acc_all")
bip3("model/basic_predict_promote_40", "lgbm_goods_last_1_acc_all")
bip3("model/basic_predict_promote_40", "catboost_goods_last_1_acc_all")

(货物)常规预测过去3个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_goods_last_2_acc_normal")
bip3("model/basic_predict_promote_40", "lgbm_goods_last_2_acc_normal")
bip3("model/basic_predict_promote_40", "catboost_goods_last_2_acc_normal")

(货物)常规预测过去2个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_goods_last_3_acc_normal")
bip3("model/basic_predict_promote_40", "lgbm_goods_last_3_acc_normal")
bip3("model/basic_predict_promote_40", "catboost_goods_last_3_acc_normal")

(货物)常规预测过去1个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_goods_last_1_acc_normal")
bip3("model/basic_predict_promote_40", "lgbm_goods_last_1_acc_normal")
bip3("model/basic_predict_promote_40", "catboost_goods_last_1_acc_normal")

############################################
(仓库货物)总预测过去3个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_last_3_acc_all")
bip3("model/basic_predict_promote_40", "lgbm_last_3_acc_all")
bip3("model/basic_predict_promote_40", "catboost_last_3_acc_all")

(仓库货物)总预测过去2个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_last_2_acc_all")
bip3("model/basic_predict_promote_40", "lgbm_last_2_acc_all")
bip3("model/basic_predict_promote_40", "catboost_last_2_acc_all")

总预测过去1个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_last_1_acc_all")
bip3("model/basic_predict_promote_40", "lgbm_last_1_acc_all")
bip3("model/basic_predict_promote_40", "catboost_last_1_acc_all")

(仓库货物)常规预测过去3个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_last_2_acc_normal")
bip3("model/basic_predict_promote_40", "lgbm_last_2_acc_normal")
bip3("model/basic_predict_promote_40", "catboost_last_2_acc_normal")

(仓库货物)常规预测过去2个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_last_3_acc_normal")
bip3("model/basic_predict_promote_40", "lgbm_last_3_acc_normal")
bip3("model/basic_predict_promote_40", "catboost_last_3_acc_normal")

(仓库货物)常规预测过去1个月准确率均值
bip3("model/basic_predict_promote_40", "xgb_last_1_acc_normal")
bip3("model/basic_predict_promote_40", "lgbm_last_1_acc_normal")
bip3("model/basic_predict_promote_40", "catboost_last_1_acc_normal")

############################################
Xgboost
# 预测
bip3("model/basic_predict_promote_40", "xgb_wh_goods_pred_normal")                         预测常规消耗量
bip3("model/basic_predict_promote_40", "xgb_wh_goods_pred_all")                            预测总消耗量

# 训练
bip3("model/basic_predict_promote_40", "train_metric_xgb_wh_goods_pred_normal")            常规品训练集准确度
bip3("model/basic_predict_promote_40", "train_metric_xgb_wh_goods_pred_all")               总训练集准确度

# 逐日
bip3("model/basic_predict_promote_40", "metric_daily_xgb_wh_goods_pred_normal")            常规品天维度准确度
bip3("model/basic_predict_promote_40", "metric_daily_goods_xgb_wh_goods_pred_normal")      常规品天维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_daily_wh_goods_xgb_wh_goods_pred_normal")   常规品天维度仓库货物级别准确度

bip3("model/basic_predict_promote_40", "metric_daily_xgb_wh_goods_pred_all)                总天维度准确度
bip3("model/basic_predict_promote_40", "metric_daily_goods_xgb_wh_goods_pred_all)          总天维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_daily_wh_goods_xgb_wh_goods_pred_all)       总天维度仓库货物级别准确度

# 逐日汇总到月度
bip3("model/basic_predict_promote_40", "metric_month_xgb_wh_goods_pred_normal")            常规品月维度准确度
bip3("model/basic_predict_promote_40", "metric_month_goods_xgb_wh_goods_pred_normal")      常规品月维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_month_wh_goods_xgb_wh_goods_pred_normal")   常规品月维度仓库货物级别准确度

bip3("model/basic_predict_promote_40", "metric_month_xgb_wh_goods_pred_all")               总月维度准确度
bip3("model/basic_predict_promote_40", "metric_month_goods_xgb_wh_goods_pred_all")         总月维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_month_wh_goods_xgb_wh_goods_pred_all")      总月维度仓库货物级别准确度

############################################
LightGBM
# 预测
bip3("model/basic_predict_promote_40", "lgbm_wh_goods_pred_normal")                         预测常规消耗量
bip3("model/basic_predict_promote_40", "lgbm_wh_goods_pred_all")                            预测总消耗量

# 训练
bip3("model/basic_predict_promote_40", "train_metric_lgbm_wh_goods_pred_normal")            常规品训练集准确度
bip3("model/basic_predict_promote_40", "train_metric_lgbm_wh_goods_pred_all")               总训练集准确度

# 逐日
bip3("model/basic_predict_promote_40", "metric_daily_lgbm_wh_goods_pred_normal")            常规品天维度准确度
bip3("model/basic_predict_promote_40", "metric_daily_goods_lgbm_wh_goods_pred_normal")      常规品天维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_daily_wh_goods_lgbm_wh_goods_pred_normal")   常规品天维度仓库货物级别准确度

bip3("model/basic_predict_promote_40", "metric_daily_lgbm_wh_goods_pred_all)                总天维度准确度
bip3("model/basic_predict_promote_40", "metric_daily_goods_lgbm_wh_goods_pred_all)          总天维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_daily_wh_goods_lgbm_wh_goods_pred_all)       总天维度仓库货物级别准确度

# 逐日汇总到月度
bip3("model/basic_predict_promote_40", "metric_month_lgbm_wh_goods_pred_normal")            常规品月维度准确度
bip3("model/basic_predict_promote_40", "metric_month_goods_lgbm_wh_goods_pred_normal")      常规品月维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_month_wh_goods_lgbm_wh_goods_pred_normal")   常规品月维度仓库货物级别准确度

bip3("model/basic_predict_promote_40", "metric_month_lgbm_wh_goods_pred_all")               总月维度准确度
bip3("model/basic_predict_promote_40", "metric_month_goods_lgbm_wh_goods_pred_all")         总月维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_month_wh_goods_lgbm_wh_goods_pred_all")      总月维度仓库货物级别准确度


############################################
catboost
# 预测
bip3("model/basic_predict_promote_40", "catboost_wh_goods_pred_normal")                         预测常规消耗量
bip3("model/basic_predict_promote_40", "catboost_wh_goods_pred_all")                            预测总消耗量

# 训练
bip3("model/basic_predict_promote_40", "train_metric_catboost_wh_goods_pred_normal")            常规品训练集准确度
bip3("model/basic_predict_promote_40", "train_metric_catboost_wh_goods_pred_all")               总训练集准确度

# 逐日
bip3("model/basic_predict_promote_40", "metric_daily_catboost_wh_goods_pred_normal")            常规品天维度准确度
bip3("model/basic_predict_promote_40", "metric_daily_goods_catboost_wh_goods_pred_normal")      常规品天维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_daily_wh_goods_catboost_wh_goods_pred_normal")   常规品天维度仓库货物级别准确度

bip3("model/basic_predict_promote_40", "metric_daily_catboost_wh_goods_pred_all)                总天维度准确度
bip3("model/basic_predict_promote_40", "metric_daily_goods_catboost_wh_goods_pred_all)          总天维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_daily_wh_goods_catboost_wh_goods_pred_all)       总天维度仓库货物级别准确度

# 逐日汇总到月度
bip3("model/basic_predict_promote_40", "metric_month_catboost_wh_goods_pred_normal")            常规品月维度准确度
bip3("model/basic_predict_promote_40", "metric_month_goods_catboost_wh_goods_pred_normal")      常规品月维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_month_wh_goods_catboost_wh_goods_pred_normal")   常规品月维度仓库货物级别准确度

bip3("model/basic_predict_promote_40", "metric_month_catboost_wh_goods_pred_all")               总月维度准确度
bip3("model/basic_predict_promote_40", "metric_month_goods_catboost_wh_goods_pred_all")         总月维度货物级别准确度
bip3("model/basic_predict_promote_40", "metric_month_wh_goods_catboost_wh_goods_pred_all")      总月维度仓库货物级别准确度
...
def train_and_evaluate_models(target_date, model_label, data_label, sel_goods_ls, window):
    ...
    ld_feature = get_feature(data_label=data_label,target_date=target_date,sel_goods_ls=sel_goods_ls)
    df_feature = ld_feature.query(f"'{start_dt}'<=ds <'{target_date}'")

    ld_feature['goods_id'] = ld_feature['goods_id'].astype(int)
    df_feature['goods_id'] = df_feature['goods_id'].astype(int)
    # 不划分训练集/测试集
    train_ratio = 1
    ...
    # 训练
    X_train['goods_id'] = X_train['goods_id'].astype(int)
    model = train_model(
        X_train=X_train, y_train=y_train, model_label=model_label)
...
def train_lightgbm(X_train, y_train):
    log.debug('lgbm')
    model = lgb.LGBMRegressor(objective='regression', num_leaves=31, learning_rate=0.05, n_estimators=1500, verbose=-1)
    model.fit(X_train, y_train, eval_set=[(X_train, y_train)], eval_metric='l2', verbose=-1)
...
def predict_daily_1(ld_feature, df_true, sel_goods_ls, features, model, start_dt, window=29):
    ...
    for dt in pd.date_range(start_dt, day_30):
        ...
        # 构造新特征
        df_feature_wh_goods = wh_goods_feature_generated(df=df_true_new, sel_goods_ls=sel_goods_ls)
...
def wh_goods_feature_generated(df, sel_goods_ls):
    # 构造特征
    df_feature_wh_goods = pd.DataFrame()
    for wh_id in df["wh_dept_id"].unique():
        for g_id in df.query(f"wh_dept_id == {wh_id}")["goods_id"].unique():
            df_wh_goods = (df.query(f"wh_dept_id == {wh_id} and  goods_id == {g_id}")
                           .reset_index(drop=True).copy())
            df_wh_goods = feature_generated(df=df_wh_goods)
            df_feature_wh_goods = pd.concat([df_feature_wh_goods, df_wh_goods])

    return df_feature_wh_goods
...
def get_feature(data_label, target_date, sel_goods_ls):
    # start_dt = DayStr.n_day_delta(target_date, n=-130)
    start_dt = '2022-01-01'
    end_dt = DayStr.n_day_delta(target_date, n=+30)

    if data_label == 'normal':
        ld_base = read_api.read_dt_folder(
            bip3("model/basic_predict_promote", "feature_engineering_wh_goods_normal")
            , start_dt, end_dt)
    ...
    if data_label == 'all':
        ld_base = read_api.read_dt_folder(
            bip3("model/basic_predict_promote", "feature_engineering_wh_goods_all")
            , start_dt, end_dt)
        ld_base.query(f"goods_id == {sel_goods_ls}", inplace=True)
        ld_base.sort_values('ds', inplace=True)
        ld_base['y'] = ld_base['y'].round(1)
...
def save_pred_df(df_daily_pred, df_month_pred, model_label, data_label, dt):
    ...
    bip3_save_df2(df_daily_pred,
                  ...
                  bip_folder='model/basic_predict_promote_40',
...
def recent_month_wh_goods_metric_mean(data_label, model_label, window):
    ...
    df_metric = read_api.read_dt_folder(
        bip3("model/basic_predict_promote_40", f"metric_month_wh_goods_{model_label}_wh_goods_pred_{data_label}"),
...
def recent_month_goods_metric_mean(data_label, model_label, window):
    ...
    # 最近3个月准确率均值
    df_metric = read_api.read_dt_folder(
        bip3("model/basic_predict_promote_40", f"metric_month_goods_{model_label}_wh_goods_pred_{data_label}"),
        start_dt, pred_minus1_day
    )
    df_metric['dt'] = pd.to_datetime(df_metric['dt'])
